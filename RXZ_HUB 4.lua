...
local RXZ_LIB do
    ...
    label(Header, "Title", "RXZ HUB", UDim2.new(1, -90, 0, 26), UDim2.fromOffset(14, 12), 22, C.White, Enum.Font.Bangers)
    label(Header, "Sub", "MM2 SCRIPT", UDim2.new(1, -90, 0, 14), UDim2.fromOffset(14, 36), 11, C.Gray, Enum.Font.Bangers)

    local Divider = Instance.new("Frame")
    Divider.Size = UDim2.new(1, -28, 0, 1)
    Divider.Position = UDim2.fromOffset(14, 60)
    ...
    Tabs.Size = UDim2.new(0, 76, 1, -72)
    Tabs.Position = UDim2.new(1, -84, 0, 66)
