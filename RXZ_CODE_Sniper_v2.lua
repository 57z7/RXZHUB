...
local function addSettingsBackground(parent)
    ...
    addCorner(bg, 14)
    local clip = target
    if clip:IsA("Frame") then clip.ClipsDescendants = true end
    return bg
end
...
local function makeCard(name, position, size)
    ...
    card.Name = name card.Position = position card.Size = size card.BackgroundColor3 = COLORS.Row card.BackgroundTransparency = 0.35 card.BorderSizePixel = 0 card.Parent = SniperSettings addCorner(card,
    10)
...
SniperBottomBar.BackgroundColor3 = COLORS.Row SniperBottomBar.BackgroundTransparency = 0.35 SniperBottomBar.BorderSizePixel = 0 SniperBottomBar.Parent = SniperWindow addCorner(SniperBottomBar,
16)
...
SolvedCard.BackgroundColor3 = COLORS.Row SolvedCard.BackgroundTransparency = 0.35 SolvedCard.BorderSizePixel = 0 SolvedCard.Parent = RiddleSettings addCorner(SolvedCard,
10)
...
RiddleBottomBar.BackgroundColor3 = COLORS.Row RiddleBottomBar.BackgroundTransparency = 0.35 RiddleBottomBar.BorderSizePixel = 0 RiddleBottomBar.Parent = RiddleWindow addCorner(RiddleBottomBar,
16)
